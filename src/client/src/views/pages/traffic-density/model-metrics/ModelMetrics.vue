<template>
    <div class="card">
      <h4>Vehicle Count Model Metrics</h4>
      <Dropdown v-model="selectedRoute" :options="routes" :loading="loading" @change="onRouteSelected" filter optionLabel="value" placeholder="Select a location" class="w-full md:w-20rem">
...
const onRouteSelected = () => {
  fetchVehicleCounterModelMetrics(selectedRoute.value.value);
};
...
const fetchVehicleCounterModelMetrics = async () => {
